export const YearMonthDate = (date) => {
    ...
    const formattedDate = `${dateObj.getFullYear()}-${dateObj.getMonth() < 10 ? prefixZero(dateObj.getMonth() + 1): dateObj.getMonth() + 1 }-${dateObj.getDate() < 10 ? prefixZero(dateObj.getDate() + 1) : dateObj.getDate() + 1}`;
